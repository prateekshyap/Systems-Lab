...
>Question-1 --> ___java Restaurant___

>Question-2 --> ___java Wedding___

>Question-3 --> ___java Restaurant___
...
4. [RECOMPILATION] To RECOMPILE the codes, go inside respective folder and
    1) type _"make"_ and press enter in Linux terminal.
    2) type ___"javac *.java"___ and press enter in windows Command Prompt.
